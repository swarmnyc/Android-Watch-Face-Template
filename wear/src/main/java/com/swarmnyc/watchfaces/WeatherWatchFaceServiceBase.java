...
public abstract class WeatherWatchFaceServiceBase extends CanvasWatchFaceService {
    public class WeatherWatchFaceEngine extends CanvasWatchFaceService.Engine
        ...
        private WatchFaceService mService;

        public WeatherWatchFaceEngine(WatchFaceService service) {
            mService = service;
            mGoogleApiClient = new GoogleApiClient.Builder(mService)
        ...
        protected void log(String message) {
            Log.d(mService.getClass().getSimpleName(), message);
        }
        ...
        protected void registerTimeZoneService() {
            ...
            mService.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        protected void unregisterTimeZoneService() {
            ...
            //TimeZone
            mService.unregisterReceiver(mTimeZoneReceiver);
        }
